...
export const Home = () => {
  ...
  return (
    <>
      <div className="flex content-center items-center" style={{height: '85vh'}}>
          ...
          <div style={{width: '45vw', overflow: 'hidden'}}>
            ...
            <div name='mainContentAtCenter' className="flex flex-col justify-between items-center content-center break-words">
              ...
              <div>
                ...
                <br></br>
                <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Explore Terna</button>
              </div>
