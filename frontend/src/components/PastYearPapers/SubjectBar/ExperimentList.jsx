...
export const ExperimentList = (props) => {
  ...
  return (
    ...
    <section className=' flex max-sm:flex-col gap-3 bg-slate-500 items-center text-white p-2 rounded-lg m-2 justify-between '>
        ...
        <div className='flex gap-2 flex-wrap'>
          ...
          <button className='bg-white text-gray-500 p-2 rounded-lg max-sm:w-full shadow-lg' onClick={downloadNormal}>Download docx</button>
        </div>
    </section>
    </>
  )
