...
const CoderTabIndex = ({ setProgress }) => {
  const [platfrom, setPlatform] = useState(null); //codechef, github, leetcode
  ...
  const leetcodeIconLink =
    "https://cdn.iconscout.com/icon/free/png-256/free-leetcode-3521542-2944960.png?f=webp";
  ...
  return (
    <div>
      ...
      <div className="flex gap-2">
        ...
        <span onClick={()=>openLink('leetcode')}>
            <Typography
            variant="subtitle1"
            gutterBottom
            className={`platforms-option ${
            ...
            >
            <img src={leetcodeIconLink} className="h-6 w-6" />
            LeetCode
            </Typography>
        </span>
      </div>
